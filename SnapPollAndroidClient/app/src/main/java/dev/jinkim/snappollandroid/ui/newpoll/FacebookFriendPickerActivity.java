...
public class FacebookFriendPickerActivity extends FragmentActivity {
    ...
    public static final String TAG = FacebookFriendPickerActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.facebook_friend_picker);
        ...
        if (FRIEND_PICKER.equals(intentUri)) {
            ...
            friendPickerFragment.setOnErrorListener(new PickerFragment.OnErrorListener() {
                ...
                public void onError(PickerFragment<?> fragment, FacebookException error) {
                    FacebookFriendPickerActivity.this.onError(error);
                }
            });
...
//                    onError(getResources().getString(R.string.no_location_error), true);
                    onError("Error: No location", true);
                }
            } catch (Exception ex) {
                onError(ex);
            }
